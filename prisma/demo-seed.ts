...
async function main() {
  ...
  const auditLogs = [
    auditEntry(
      "INVENTORY_ITEM",
      createdInventory[0].id,
      "CREATED",
      "Created inventory item: Signs",
      admin.id,
      35,
    ),
    auditEntry(
      ...
      pastEvent.id,
      "CREATED",
      "Created event: Acme Corp — Annual Awards Gala",
      admin.id,
      35,
    ),
    auditEntry(
      ...
      invRes1.id,
      "CREATED",
      "Requested 2× Signs for Annual Awards Gala",
      user.id,
      32,
    ),
    auditEntry(
      ...
      invRes1.id,
      "APPROVED",
      "Approved 2× Signs for Annual Awards Gala",
      admin.id,
      31,
    ),
    auditEntry(
    ...
    auditEntry(
      ...
      ongoingEvent.id,
      "CREATED",
      "Created event: Horizon Tech — Product Launch Summit",
      admin.id,
      10,
    ),
    auditEntry(
      ...
      invRes2.id,
      "CREATED",
      "Requested 10× Stanchions for Product Launch Summit",
      user.id,
      8,
    ),
    auditEntry(
      ...
      invRes2.id,
      "APPROVED",
      "Approved 10× Stanchions for Product Launch Summit",
      admin.id,
      7,
    ),
    auditEntry(
      ...
      futureEvent.id,
      "CREATED",
      "Created event: Stellar Brands — Holiday Party",
      admin.id,
      5,
    ),
    auditEntry(
      ...
      invRes3.id,
      "CREATED",
      "Requested 1× Ticket Booth for Holiday Party",
      user.id,
      3,
    ),
  ];
